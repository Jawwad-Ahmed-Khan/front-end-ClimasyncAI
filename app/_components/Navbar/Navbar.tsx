            ...
            >
                ...
                <div
                    className={`relative transition-all duration-500 ${isScrolled
                            ...
                            : "bg-gradient-to-b from-slate-950/95 to-slate-950/70 backdrop-blur-xl"
                        }`}
                    style={{
                    ...
                    <div className="relative flex items-center px-6 md:px-10 lg:px-16 py-4">
                        ...
                        <div className="flex-shrink-0">
                            <Link href="/" className="flex items-center gap-4 group">
                                ...
                                >
                                    {/* Glow Ring */}
                                    <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full opacity-0 group-hover:opacity-40 blur-md transition-all duration-500" />
